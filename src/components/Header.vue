    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <a href="javascript:void(0)" class="navbar-link" @click="logindie = true" v-show="!userName">Login</a>
          <a href="javascript:void(0)" class="navbar-link" @click="dieuser">Logout</a>
            ...
            <div class="confirm-tips">
              ...
              <ul>
                ...
                <li class="regi_form_input noMargin">
                  ...
                  <input type="password" tabindex="2" name="password" v-model="userPwd11" placeholder="Password" class="regi_login_input regi_login_input_left login-input-no input_text" @keyup.enter="login">
                </li>
              </ul>
...
export default {
  ...
  methods: {
    ...
    checkLogin () {
      ...
      // var userName = document.cookie.split(';')[2].split('=')[2]
      // console.log(userId)
      if (userId) {
